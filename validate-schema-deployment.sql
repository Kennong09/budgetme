...
DECLARE
    expected_tables TEXT[] := ARRAY[
        ...
        'user_notifications', 'notification_preferences', 'notification_delivery_log', 'notification_templates', 'notification_aggregation_rules'
    ];
    missing_tables TEXT[] := '{}';
    table_name TEXT;
...
DECLARE
    expected_functions TEXT[] := ARRAY[
        ...
        'create_notification', 'mark_notification_read', 'cleanup_expired_notifications', 'get_user_notification_count',
